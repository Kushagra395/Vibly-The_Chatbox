    ...
    try {
       ...
       //hashing password
        ...
        if ( newUser ) {
            ...
            return res.status(201).json({   //status send which can be seen on postman
                id: newUser._id,
...
export const updateProfile = async (req, res) => {
    ...
    const updatedUser = await User.findByIdAndUpdate(userId, {profilePic:uploadResponse.secure_url}, {new:true}) //user ke data base mai update kiya photo and new data updated user mai dalne ke liye {new:true} kiya nhi tho update ke pehle wala jata new thing to learn
